...
public class Principal {
	...
	private NuevaSerie nuevaSerie;
	private BorrarSerie borrarSerie;
	private MostrarSerie mostrarSerie;
	...
	private void initialize() {
		...
		mntmNuevaSerie.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				nuevaSerie=new NuevaSerie();
		...
		mntmBorrarSerie.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				borrarSerie=new BorrarSerie();
				borrarSerie.setVisible(true);
			}
		});
		mnSeries.add(mntmBorrarSerie);
		
		JMenuItem mntmMostarSeries = new JMenuItem("Mostar series");
		mntmMostarSeries.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				mostrarSerie=new MostrarSerie();
				mostrarSerie.setVisible(true);
			}
		});
